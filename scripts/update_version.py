...
def main():
  ...
  plistpath = scriptpath + "/resources/Sostenuto-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sostenuto-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sostenuto-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sostenuto-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Sostenuto-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Sostenuto.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Sostenuto.iss",inplace=1):
