...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Sostenuto Demo Installer\n"
      else:
        line="OutputBaseFilename=Sostenuto Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Sostenuto Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Sostenuto installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Sostenuto Demo installer\n"
     else:
       line="SetupWindowTitle=Sostenuto installer\n"
